...
-   $$H_1 : \exists(i, j)\ tel\ que\ µ_i≠µ_j$$ <!--% Vérification des conditions d'application -->
...
-   P \< alpha, on rejette Ho donc il n'y a pas d'homoscédasticité : au moins une des variences est significativement différentes au seuil alpha (Bartlett, dll = 3, P \< 2.2e-16) \### ANOVA à un facteur 2
