...
On ne peut donc pas conclure qu'il y aie de différence significative entre la masse corrigée au seuil α de 5% à la fois en fonction d'un cas d'intolérence au lactose (*F* = 17,2, ddl = 1 et 197, valeur *p* \<\< 0,001), d'un cas d\'intolérance au gluten (*F* = 436, ddl = 1 et 197, valeur *p* \<\< 0,001) et d'un cas d'intolérance au lactose et au gluten (

Donc le graphique semble montrer qu'il y a interaction entre
