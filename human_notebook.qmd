...
smutate(biometry, poids_ideal_age <- sgroup_by(biometry, poids_ideal, age))
smutate(biometry, poids_ideal_age = case_when(
    poids_ideal < 50 ~ "Très mince",
    poids_ideal >= 50  & poids_ideal < 60 ~ "Mince",
    poids_ideal >= 60 & poids_ideal < 75 ~ "Normal",
    poids_ideal >= 75 & poids_ideal < 90 ~ "Surpoids",
    poids_ideal >= 90 ~ "Surpoids")) %>.%
