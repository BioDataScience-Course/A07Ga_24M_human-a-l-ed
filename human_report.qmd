...
Ce test Chi carré d'indépendance montre qu'il existe un lien entre activité physique et poids "idéal" (via un découpage en différentes catégories pour chacune des variables pour en obtenir des variables facteurs), on observe une valeur p inférieure au seuil alpha de 5% (0.01833) : donc nous rejetons H_0 et il y a bien un lien de corrélation entre l'activité physique et le poids "idéal" (x-squared = 19.933 , df = 9, p-value = 0.01833).
