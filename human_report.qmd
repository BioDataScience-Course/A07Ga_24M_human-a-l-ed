...
Cette étude porte sur l'analyse de différentes variables liée ou pas à l'obésité, elle a été réalisé par un groupe d'une trentaines d'expérimentateurs qui ont interrogés et mesurer 144 personnes du Hainaut aux totales sur plusieurs variables. Pour les mesures de la masse, une intercalibration à été effectué au préalable, via l'utilisation d'une balance commune. Les mesures de taille etc... ont été considéré comme assez précise avec des instruments de mesure personelles. Le reste des mesures sont des simples questions posées aux individus qui sont fiables car l'anonymat est garantie.
